function getProductDataV() {
    $.post('php/productosNuevosV.php', response => {
      let resp = JSON.parse(response);
      console.log("Consulta de ultimos productos");
      for (const product of resp.data) {
        ...
        document.getElementById('productosmainV').appendChild(productDiv);
      }
    });

    $.post('php/productosNuevosA.php', response => {
      let resp = JSON.parse(response);
      console.log("Consulta de ultimos productos");
      for (const product of resp.data) {
        /* Create category table row for each category on the response */
        ...
        productDiv.appendChild(singleProduct);
        document.getElementById('productosmainA').appendChild(productDiv);
      }
    });
  }
